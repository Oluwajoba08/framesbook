  ...
  return (
    <div className="fixed group right-9 bottom-5 z-40 rounded-full shad-css">
      <Link href={`/new`} className={`rounded-full bg-[--off-bg-main] p-3.5 flex justify-center items-center `}>
        <i className={`bg-auto w-5 h-5 bg-no-repeat inline-block `} style={{ backgroundImage: " url('/fb-icons.png')", backgroundPosition: "0px -189px", backgroundBlendMode: "exclusion" }}></i>
      </Link>
