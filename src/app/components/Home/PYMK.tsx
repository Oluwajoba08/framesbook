...
const PYMK = ({ id, name, image, mutualFriends, link }: PMYK) => {
  ...
  return (
    <div className={`${close ? "hidden" : "flex flex-col"} w-[200px] h-[280px] rounded-md overflow-x-hidden`}>
      ...
      <div className="flex flex-col p-2 border-x border-b border-[--off-bg-main-off-hover] rounded-b-md ">
        ...
        >
          ...
          {hover && (
            <div
              style={{
                left: hoverCoordinates.x,
                top: hoverCoordinates.y,
              }}
              className={`fixed z-[1200] w-80 border border-[--off-bg-main-off] gap-3 rounded-md shad-css bg-[--bg-main] p-2 flex flex-col`}
            >
