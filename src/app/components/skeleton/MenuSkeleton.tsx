        ...
        <div className={`flex flex-col col-span-2 bg-[--bg-main] p-4 rounded-md`}>
          ...
          <div className="flex flex-col gap-7 mt-2">
            <div className={`flex rounded items-center gap-2`}>
              <div className="flex">
                <span style={{ animationDelay: "0s" }} className={`h-9 w-9 rounded-full`}></span>
              </div>
              <div className={`flex flex-col gap-2 w-full`}>
                <span style={{ animationDelay: "0.1s" }} className="h-4 w-32 rounded-full"></span>
                <span style={{ animationDelay: "0.2s" }} className="h-4 w-full rounded-full"></span>
              </div>
            </div>
            <div className={`flex rounded items-center gap-2`}>
              <div className="flex">
                <span style={{ animationDelay: "0.3s" }} className={`h-9 w-9 rounded-full`}></span>
              </div>
              <div className={`flex flex-col gap-2 w-full`}>
                <span style={{ animationDelay: "0.4s" }} className="h-4 w-32 rounded-full"></span>
                <span style={{ animationDelay: "0.5s" }} className="h-4 w-full rounded-full"></span>
              </div>
            </div>
            <div className={`flex rounded items-center gap-2`}>
              <div className="flex">
                <span style={{ animationDelay: "0.6s" }} className={`h-9 w-9 rounded-full`}></span>
              </div>
              <div className={`flex flex-col gap-2 w-full`}>
                <span style={{ animationDelay: "0.7s" }} className="h-4 w-24 rounded-full"></span>
                <span style={{ animationDelay: "0.8s" }} className="h-4 w-full rounded-full"></span>
              </div>
            </div>
            <div className={`flex rounded items-center gap-2`}>
              <div className="flex">
                <span style={{ animationDelay: "0.9s" }} className={`h-9 w-9 rounded-full`}></span>
              </div>
              <div className={`flex flex-col gap-2 w-full`}>
                <span style={{ animationDelay: "1s" }} className="h-4 w-28 rounded-full"></span>
                <span style={{ animationDelay: "1.1s" }} className="h-4 w-full rounded-full"></span>
              </div>
            </div>
            <div className={`flex rounded items-center gap-2`}>
              <div className="flex">
                <span style={{ animationDelay: "1.2s" }} className={`h-9 w-9 rounded-full`}></span>
              </div>
              <div className={`flex flex-col gap-2 w-full`}>
                <span style={{ animationDelay: "1.3s" }} className="h-4 w-32 rounded-full"></span>
                <span style={{ animationDelay: "1.4s" }} className="h-4 w-full rounded-full"></span>
              </div>
            </div>
            <div className={`flex rounded items-center gap-2`}>
              <div className="flex">
                <span style={{ animationDelay: "1.5s" }} className={`h-9 w-9 rounded-full`}></span>
              </div>
              <div className={`flex flex-col gap-2 w-full`}>
                <span style={{ animationDelay: "1.6s" }} className="h-4 w-32 rounded-full"></span>
                <span style={{ animationDelay: "1.7s" }} className="h-4 w-full rounded-full"></span>
              </div>
            </div>
          </div>
        </div>
